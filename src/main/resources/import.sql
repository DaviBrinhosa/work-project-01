...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (1, 1, '(91)8765-4321', 'joao.silva@example.com', 'João Silva');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (2, 1, '(91)9988-8777', 'maria.souza@example.com', 'Maria Souza');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (3, 1, '(51)5544-4333', 'pedro.santos@example.com', 'Pedro Santos');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (4, 1, '(11)1122-2333', 'ana.oliveira@example.com', 'Ana Oliveira');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (5, 1, '(71)7788-8999', 'lucas.fernandes@example.com', 'Lucas Fernandes');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (6, 1, '(31)3344-4555', 'mariana.costa@example.com', 'Mariana Costa');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (7, 1, '(21)2233-3444', 'carlos.silveira@example.com', 'Carlos Silveira');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (8, 1, '(61)6677-7888', 'ana.lima@example.com', 'Ana Lima');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (9, 1, '(91)9900-0111', 'jose.santana@example.com', 'José Santana');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (10, 1, '(11)1122-2333', 'lucas.silva@example.com', 'Lucas Silva');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (11, 1, '(31)3344-4555', 'maria.martins@example.com', 'Maria Martins');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (12, 1, '(51)5566-6777', 'jose.rodrigues@example.com', 'José Rodrigues');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (13, 1, '(71)7788-8999', 'pedro.almeida@example.com', 'Pedro Almeida');
...
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (14, 1, '(81)8899-9000', 'maria.silva@example.com', 'Maria Silva');

INSERT INTO address (user_id, building_number, city, complement, district, region, street_address, zip_code) VALUES (null, 150, 'Rio de Janeiro', 'Casa 15', 'Laranjeiras', 'RJ', 'Rua O', '56789-012');
INSERT INTO contact (address_id, user_id, cellphone, email, name) VALUES (15, 1, '(21)2233-3444', 'lucas.rodrigues@example.com', 'Lucas Rodrigues');
